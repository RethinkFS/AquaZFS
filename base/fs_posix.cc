...
int cloexec_flags(int flags, const FileOptions *options) {
...
public:
  ...
  void SetFD_CLOEXEC(int fd, const FileOptions *options) {
...
private:
  ...
  static size_t GetLogicalBlockSizeForReadIfNeeded(const FileOptions &options,
                                                   const std::string &fname,
                                                   int fd);

  static size_t GetLogicalBlockSizeForWriteIfNeeded(const FileOptions &options,
                                                    const std::string &fname,
                                                    int fd);
};
...
size_t PosixFileSystem::GetLogicalBlockSizeForReadIfNeeded(
    const FileOptions &options, const std::string &fname, int fd) {
